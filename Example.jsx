...
const Panel = ({ user }) => {
  ...
  return (
    <Container>
      ...
      <Button onClick={handleUpdateImg}>Сурта хийца</Button>
      <Tabs>
        <Tab
      ...
      {activeTab === "profile" && (
        <div>
          ...
          />
          <ButtonContainer>
            <Button onClick={handleUpdate}>Хийца</Button>
          </ButtonContainer>
        </div>
      )}
      {activeTab === "following" && (
        <ul>
          {subscribedUsers.map((user) => (
            ...
            >
              {user.name} ({user.subscribers} йазвалархо)
            </Li>
          ))}
        </ul>
      )}
